...
public class TaskTwo {
	...
	public static void main(String[] arg)
	{
		...
		driver.findElement(By.xpath("//*[@id=\"first_name\"]")).sendKeys("Akash");
		driver.findElement(By.xpath("//*[@id=\"last_name\"]")).sendKeys(" S");
		driver.findElement(By.xpath("//*[@id=\"user_email\"]")).sendKeys("akash@gmail.com");
		driver.findElement(By.xpath("//*[@id=\"radio_1665627729_Male\"]")).click();
		driver.findElement(By.xpath("//*[@id=\"user_pass\"]")).sendKeys("akash123");
