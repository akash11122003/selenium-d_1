...
public class TaskOne {
	...
	public static void main(String[] arg) throws InterruptedException
	{
		...
		driver.findElement(By.xpath("//*[@id=\"input-lastname\"]")).sendKeys(" Sasikumar");
		driver.findElement(By.xpath("//*[@id=\"input-email\"]")).sendKeys("aakash@gmail.com");
		JavascriptExecutor js=(JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(0,1000)", "");
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"input-password\"]")).sendKeys("aakash123");
